...
class StepByStep(object):
    ...
    def train_step_fn(self, x: torch.Tensor, y: torch.Tensor) -> float:
    ...
    def val_step_fn(self, x: torch.Tensor, y: torch.Tensor) -> float:
    ...
    def _mini_batch(self, validation: bool = False) -> float:
        """
